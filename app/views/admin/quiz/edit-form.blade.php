                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select name="subject_id" id="" class="form-control">
                                    ...
                                    <option {{ $quiz->subject_id == $s->id?"selected":""}} value="{{$s->id}}">
                                        {{$s->name}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-check mt-5">
                                <input class="form-check-input" name="status" @if ($quiz->status == 1) {{"checked" }} @endif type="checkbox" value="1" id="status">
                                <label class="form-check-label" for="status">
                                    Online
                                </label>
                            </div>
                            <div class="form-check mt-5">
                                <input class="form-check-input" name="is_shuffle" @if ($quiz->is_shuffle == 1) {{ "checked" }} @endif type="checkbox" value="1" id="is_shuffle">
